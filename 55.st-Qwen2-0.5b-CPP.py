...
modelname = 'qwen2-0_5b-instruct'
modelfile = 'qwen2-0_5b-instruct-q8_0.gguf'
...
mytitle = f'<p style="color:DarkOrchid; font-size: 32px;text-align:center;"><b>Your own LocalGPT with 🟪 {modelname}</b></p>'
st.markdown(mytitle, unsafe_allow_html=True)
#st.header("Your own LocalGPT with 🌀 h2o-danube-1.8b-chat")
subtitle = '<p style="color:DeepSkyBlue; font-size: 20px;text-align:center;"><b><i>Powerwed by Qwen2 - 0.5b parameter chat model. 32k conext window</i></b></p>'
...
# CREATE THE SIDEBAR
with st.sidebar:
    st.image('qwensidelogo.png', use_column_width=True) #use_column_width=True  #width=170
...
if "messages" not in st.session_state:
    st.session_state.messages = [
        {"role": "system", "content": "You are Qwen2-instruct, a helpful assistant. You reply only to the user questions. You always reply in the language of the instructions.",},
        {"role": "user", "content": "Hi, I am Fabio."},
        {"role": "assistant", "content": "Hi there Fabio, I am Qwen2-instruct: with my 0.5b parameters I can be useful to you. how may I help you today?"}
    ]
